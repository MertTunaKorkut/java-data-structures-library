...
public class ArrayStack<T> extends AbstractStack<T> implements Stack<T> {
  ...
  public static <T> ArrayStack<T> copyOf(ArrayStack<T> that) {
      ...
      ArrayStack<T> stack = of(that.elements);
      return stack;
  ...
  public static <T> ArrayStack<T> copyOf(Stack<T> that) {
      ArrayStack<T> tempStack = new ArrayStack<>(!that.isEmpty() ? that.size() : DEFAULT_INITIAL_CAPACITY);
      ArrayStack<T> stack = new ArrayStack<>(!that.isEmpty() ? that.size() : DEFAULT_INITIAL_CAPACITY);
